...
const About = () => {
  return (
    <>
      <div className="p-5">
        <div className="w-full h-[544.77px] ">
          <div className="relative">
            ...
            <div className="absolute top-[100px] left-[96px]">
              ...
              <p className="w-[370px]">
                #1 Online Marketplace for Electronic & Technology in Mahanttan,
                CA
              </p>
            </div>
          </div>
        ...
        <div className="w-full h-[420px] flex justify-between px-[100px] bg-white mt-8">
          <div>
            <img
              src={aboutmanpic}
              alt=""
              className="w-[646px] rounded-[10px]"
            />
          </div>
        ...
        <div className="w-full h-[1598.97px] bg-white px-5">
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <div className="w-full h-[380px] flex justify-between">
                <div>
