...
const TopCellsPhone = () => {
  return (
    <>
      <Container>
        <div className="w-full h-[880px] bg-white px-5 rounded-[10px]">
          ...
          <div className="flex justify-between border-b-2 pb-3.5 border-secundary">
            <div className="relative">
              <img
                src={topsellsbanner}
                alt=""
                className="w-[700px] h-[220px]"
              />
            ...
            <div className="w-[700px] h-[220px] py-7 pl-4">
          ...
          <div className="w-[1120px] h-[474.47px]  my-5">
