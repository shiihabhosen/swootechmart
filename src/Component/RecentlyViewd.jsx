...
const RecentlyViewd = () => {
  return (
    <>
      <div className="w-[1480px] h-[237.69px] bg-white rounded-[10px] mx-5 mb-4 ">
      ...
      <div className="px-4">
        <h4 className="tect-[18px] font-bold py-[50px] ">Swoo – #1 Online Marketplace for technology</h4>
        ...
        <p className="pt-5 w-[1150px]">
          ...
          orci eu tortor consequat mattis quis at ante. Class aptent taciti
