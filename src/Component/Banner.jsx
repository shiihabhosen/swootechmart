...
const Banner = () => {
  return (
    <>
      <Container>
        <div className=" flex justify-between w-full h-[446px] mt-4 gap-4">
          ...
          <div className=" w-[324.98px] h-full ">
            <div className="relative">
              <img src={which} alt="" className="bg-cover bg-center w-[308.98px] h-[215px] " />
              <div className="absolute top-0 pl-[130px] py-5">
            ...
            <div className="relative mt-4">
              ...
              <img
                src={camera}
                alt=""
                className="bg-cover bg-center rounded-[10px] w-[308.98px] h-[215px] "
              />
            </div>
          </div>
        </div>
