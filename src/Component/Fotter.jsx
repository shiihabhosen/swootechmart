...
const Fotter = () => {
  ...
  return (
    <>
      <div className="w-full h-[764px] bg-white">
        ...
        <div className="flex py-[60px] gap-[190px]">
          ...
          <div>
            ...
            <div className="relative flex justify-end items-center pt-[30px]">
              <input
                type="text"
                className="shadow-md w-[856.66px] px-8 py-2 focuse: outline-none rounded-[5px]"
        ...
        <div className="w-full  flex justify-between items-center border-t-1 border: text-tertiary px-5 h-[104.8px] bg-white">
          <p>
            © 2024{" "}
            <span className="font-bold">
              <a href="https://www.facebook.com/shiihabhosen">😽shihab hosen</a>
            </span>{" "}
            . All Rights Reserved
          </p>
